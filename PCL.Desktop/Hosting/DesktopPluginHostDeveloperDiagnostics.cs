...
internal sealed class DesktopPluginHostDeveloperDiagnostics : IPluginHostDeveloperDiagnostics
{
    public static DesktopPluginHostDeveloperDiagnostics Instance { get; } = new();
