...
public sealed class ConfigGenerator : IIncrementalGenerator
{
    ...
    private const string MethodPrefix =
        """[global::System.CodeDom.Compiler.GeneratedCode("PCL.Core.SourceGenerators.Essentials.ConfigGenerator", "1.0.0.0")]""";
        ...
        Func<ItemModel, string> resolveSource)
    {
        ...
        // CheckScope
        sb.Append(indentStr).Append("    ").AppendLine(MethodPrefix);
        sb.Append(indentStr).Append("    ").AppendLine(SharedConstants.ExcludeFromCodeCoverage);
