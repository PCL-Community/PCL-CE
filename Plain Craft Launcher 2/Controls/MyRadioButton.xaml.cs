...
public partial class MyRadioButton
{
    ...
    private void Radiobox_MouseUp()
    {
        ...
        if (!isMouseDown)
            return;
        LauncherLog.Log($"[Control] 按下单选按钮：{Text}");
        isMouseDown = false;
                ...
                !false.Equals(e)) // 防止默认属性变更触发动画，若强制不执行动画，则 e 为 False
            {
                switch (ColorType)
                {
                    case ColorState.White:
                    {
                        ...
                        {
                            // 勾选
                            var color3 = new NColor(ThemeManager.AppResources["ColorObject3"]);
                            ...
                            ModAnimation.AniStart(
                                ModAnimation.AaColor(this, BackgroundProperty,
                                    new NColor(255d, 255d, 255d) - Background, animationTimeOfCheck),
                        ...
                        else if (isMouseDown)
                        {
                            ...
                            ModAnimation.AniStart(
                                ModAnimation.AaColor(this, BackgroundProperty,
                                    new NColor(120d,
                                        new NColor(ThemeManager.AppResources["ColorObject8"])) - Background, 60),
                                "MyRadioButton Color " + Uuid);
                        }
                        else if (IsMouseOver)
                        {
                            ...
                            ModAnimation.AniStart(
                                new[]
                                {
                                    ModAnimation.AaColor(ShapeLogo, Shape.FillProperty,
                                        new NColor(255d, 255d, 255d) - ShapeLogo.Fill, animationTimeOfMouseIn),
                                    ModAnimation.AaColor(LabText, TextBlock.ForegroundProperty,
                                        new NColor(255d, 255d, 255d) - LabText.Foreground,
                                        animationTimeOfMouseIn)
                                }, "MyRadioButton Checked " + Uuid);
                            ModAnimation.AniStart(
                                ModAnimation.AaColor(this, BackgroundProperty,
                                    new NColor(50d,
                                        new NColor(ThemeManager.AppResources["ColorObject8"])) - Background,
                        ...
                        else
                        {
                            ...
                            ModAnimation.AniStart(
                                ...
                                {
                                    ModAnimation.AaColor(ShapeLogo, Shape.FillProperty,
                                        new NColor(255d, 255d, 255d) - ShapeLogo.Fill,
                            ...
                            ModAnimation.AniStart(
                                ModAnimation.AaColor(this, BackgroundProperty,
                                    new NColor(ThemeManager.AppResources["ColorBrushSemiTransparent"]) -
                    ...
                    case ColorState.Highlight:
                    {
                        if (Checked)
                        {
                            ...
                            ModAnimation.AniStart(
                                ...
                                {
                                    ModAnimation.AaColor(ShapeLogo, Shape.FillProperty,
                                        new NColor(255d, 255d, 255d) - ShapeLogo.Fill, animationTimeOfCheck),
                                    ModAnimation.AaColor(LabText, TextBlock.ForegroundProperty,
                                        new NColor(255d, 255d, 255d) - LabText.Foreground,
                                        animationTimeOfCheck)
                                }, "MyRadioButton Checked " + Uuid);
            ...
            else
            {
                ...
                switch (ColorType)
                {
                    case ColorState.White:
                    {
                        if (Checked)
                        {
                            Background = new NColor(255d, 255d, 255d);
                        ...
                        else
                        {
                            ...
                            ShapeLogo.Fill = new NColor(255d, 255d, 255d);
                            LabText.Foreground = new NColor(255d, 255d, 255d);
                        }
