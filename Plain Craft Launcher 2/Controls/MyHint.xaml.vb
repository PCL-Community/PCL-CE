...
Public Class MyHint
    ...
    Private Sub UpdateUI() Handles Me.Loaded
        ...
        Background = HslConverter.FromHslEnhanced(hue, 90, s.L7)
        BorderBrush = HslConverter.FromHslEnhanced(hue, 90, s.L2)
        LabText.Foreground = HslConverter.FromHslEnhanced(hue, 90, s.L2)
        BtnClose.Foreground = HslConverter.FromHslEnhanced(hue, 90, s.L2)
    End Sub
    ...
    '        If IsWarn Then
    '            BorderBrush = New ModernColor("#CCFF4444")
    '            Gradient1.Color = New ModernColor(CType(If(IsDarkMode, "#BBFF8888", "#BBFFBBBB"), String))
    '            Gradient2.Color = New ModernColor(CType(If(IsDarkMode, "#BBFF6666", "#BBFF8888"), String))
    '            Path.Fill = New ModernColor("#BF0000")
    '            LabText.Foreground = New ModernColor("#BF0000")
    '            BtnClose.Foreground = New ModernColor("#BF0000")
    ...
    '            Return
    '        Else
    '            BorderBrush = New ModernColor("#CC4D76FF")
    '            Gradient1.Color = New ModernColor("#BBB0D0FF")
    '            Gradient2.Color = New ModernColor("#BB9EBAFF")
    '            Path.Fill = New ModernColor("#0062BF")
    '            LabText.Foreground = New ModernColor("#0062BF")
    '            BtnClose.Foreground = New ModernColor("#0062BF")
    ...
    '            BorderBrush = New ModernColor("#CCE69900")
    '            Gradient1.Color = New ModernColor("#BBFFF4CE")
    '            Gradient2.Color = New ModernColor("#BBFFF5CE")
    '            Path.Fill = New ModernColor("#957500")
    '            LabText.Foreground = New ModernColor("#957500")
    '            BtnClose.Foreground = New ModernColor("#957500")
    '            Path.Data = (New GeometryConverter).ConvertFromString("F1 M 58.5832,55.4172L 17.4169,55.4171C 15.5619,53.5621 15.5619,50.5546 17.4168,48.6996L 35.201,15.8402C 37.056,13.9852 40.0635,13.9852 41.9185,15.8402L 58.5832,48.6997C 60.4382,50.5546 60.4382,53.5622 58.5832,55.4172 Z M 34.0417,25.7292L 36.0208,41.9584L 39.9791,41.9583L 41.9583,25.7292L 34.0417,25.7292 Z M 38,44.3333C 36.2511,44.3333 34.8333,45.7511 34.8333,47.5C 34.8333,49.2489 36.2511,50.6667 38,50.6667C 39.7489,50.6667 41.1666,49.2489 41.1666,47.5C 41.1666,45.7511 39.7489,44.3333 38,44.3333 Z ")
    '            Return
