...
Public Class MyMsgInput
    ...
    Private Sub Load(sender As Object, e As EventArgs) Handles MyBase.Loaded
        Try
            ...
            '动画
            Opacity = 0
            AniStart(AaColor(FrmMain.PanMsgBackground, BlurBorder.BackgroundProperty, If(MyConverter.IsWarn, New ModernColor(140, 80, 0, 0), ModernColor.Black.WithAlpha(90)) - FrmMain.PanMsgBackground.Background.AsColor(), 200), "PanMsgBackground Background")
            AniStart({
