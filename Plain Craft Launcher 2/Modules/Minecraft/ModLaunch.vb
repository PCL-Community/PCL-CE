...
#End Region
    ...
    '登录主模块加载器
    Public McLoginLoader As New LoaderTask(Of McLoginData, McLoginResult)("登录", AddressOf McLoginStart, AddressOf McLoginInput) With {.ReloadTimeout = 1, .ProgressWeight = 15, .Block = False}
