...
#Region "启动与前后处理"
    ...
    Private Sub McLaunchPrerun()
        ...
        Try
            ...
            SetGPUPreference(Paths.ExePathWithName, Setup.Get("LaunchAdvanceGraphicCard"))
        Catch ex As Exception
    ...
    Private Sub McLaunchCustom(Loader As LoaderTask(Of Integer, Integer))
        ...
        Try
            Dim CmdString As String =
                ...
                "echo 游戏已退出。" & vbCrLf &
                "pause"
            WriteFile(If(CurrentLaunchOptions.SaveBatch, Paths.ExePath & "PCL\LatestLaunch.bat"), FilterAccessToken(CmdString, "F"),
    ...
    Private Function ArgumentReplace(Raw As String, ReplaceTimeAndDate As Boolean) As String
        ...
        End If
        Raw = Raw.Replace("{path}", Paths.ExePath)
        Return Raw
    End Function
