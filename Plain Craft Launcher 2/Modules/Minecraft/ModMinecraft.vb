...
#Region "读取默认（Original）文件夹，即当前、官启文件夹，可能没有结果"
            ...
            '扫描当前文件夹
            Try
                If Directory.Exists(Paths.ExePath & "versions\") Then originalMcFolderList.Add(New McFolder With {.Name = "当前文件夹", .Path = Paths.ExePath, .Type = McFolderType.Original})
                For Each folder As DirectoryInfo In New DirectoryInfo(Paths.ExePath).GetDirectories
...
#End Region
            ...
            If Not cacheMcFolderList.Any() Then
                ...
                cacheMcFolderList.Add(New McFolder With {.Name = "当前文件夹", .Path = Paths.ExePath & ".minecraft\", .Type = McFolderType.Original})
            End If
