        ...
        SyncLock HelpLoadLock '避免重复解压文件导致出错
            Try
                ...
                Try
                    ...
                    '读取自定义文件
                    If Directory.Exists(Paths.ExePath & "PCL\Help\") Then
                        For Each File In Directories.EnumerateFiles(Paths.ExePath & "PCL\Help\")
...
NextFile:
    ...
    Public Function HelpArgumentReplace(Xaml As String) As String
        Dim Result = Xaml.Replace("{path}", EscapeXML(Paths.ExePath))
