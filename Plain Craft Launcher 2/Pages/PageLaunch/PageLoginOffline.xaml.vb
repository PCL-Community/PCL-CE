...
Public Class PageLoginOffline
    ...
    Private Sub BtnLogin_Click(sender As Object, e As EventArgs) Handles BtnLogin.Click
        ...
        Dim UsernameValidateResult = New RegexValidator("^[A-z0-9_]{3,16}$").Validate(Username).IsValid
        If UsernameValidateResult <> True Then
        ...
        If RadioUuidCustom.Checked Then
            ...
            Dim UuidValidateResult = New RegexValidator("^[a-fA-F0-9]{32}$").Validate(UuidInput).IsValid
            If RadioUuidCustom.Checked AndAlso UuidValidateResult <> True Then
