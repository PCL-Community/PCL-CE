...
public partial class PageInstanceSetup
{
    ...
    public void Reset()
    {
        try
        {
            ...
            HintService.Hint(Lang.Text("Instance.Setup.Initialize.Success"), HintType.Finish, false);
        }
        catch (Exception ex)
        {
    ...
    private void JavaSelectionUpdate(object sender, SelectionChangedEventArgs e)
    {
        ...
        else if (selectedItem.Tag is UseRelativePath)
        {
            ...
            {
                HintService.Hint(Lang.Text("Instance.Setup.Java.PathOutOfRange"), HintType.Critical);
                return;
            }
