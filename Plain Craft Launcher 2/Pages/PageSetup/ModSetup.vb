...
#Region "UI"
    ...
    Public Sub UiCustomType(Value As Integer)
        If FrmHomepageSetup Is Nothing Then Return
        Select Case Value
            Case 0 '无
                FrmHomepageSetup.PanCustomPreset.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomLocal.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomNet.Visibility = Visibility.Collapsed
                FrmHomepageSetup.HintCustom.Visibility = Visibility.Collapsed
                FrmHomepageSetup.HintCustomWarn.Visibility = Visibility.Collapsed
            Case 1 '本地
                FrmHomepageSetup.PanCustomPreset.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomLocal.Visibility = Visibility.Visible
                FrmHomepageSetup.PanCustomNet.Visibility = Visibility.Collapsed
                FrmHomepageSetup.HintCustom.Visibility = Visibility.Visible
                FrmHomepageSetup.HintCustomWarn.Visibility = If(Setup.Get("HintCustomWarn"), Visibility.Collapsed, Visibility.Visible)
                FrmHomepageSetup.HintCustom.Text = $"从 PCL 文件夹下的 Custom.xaml 读取主页内容。{vbCrLf}你可以手动编辑该文件，向主页添加文本、图片、常用网站、快捷启动等功能。"
                FrmHomepageSetup.HintCustom.EventType = ""
                FrmHomepageSetup.HintCustom.EventData = ""
            Case 2 '联网
                FrmHomepageSetup.PanCustomPreset.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomLocal.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomNet.Visibility = Visibility.Visible
                FrmHomepageSetup.HintCustom.Visibility = Visibility.Visible
                FrmHomepageSetup.HintCustomWarn.Visibility = If(Setup.Get("HintCustomWarn"), Visibility.Collapsed, Visibility.Visible)
                FrmHomepageSetup.HintCustom.Text = $"从指定网址联网获取主页内容。服主也可以用于动态更新服务器公告。{vbCrLf}如果你制作了稳定运行的联网主页，可以点击这条提示投稿，若合格即可加入预设！"
                FrmHomepageSetup.HintCustom.EventType = "打开网页"
                FrmHomepageSetup.HintCustom.EventData = "https://github.com/Hex-Dragon/PCL2/discussions/2528"
            Case 3 '预设
                FrmHomepageSetup.PanCustomPreset.Visibility = Visibility.Visible
                FrmHomepageSetup.PanCustomLocal.Visibility = Visibility.Collapsed
                FrmHomepageSetup.PanCustomNet.Visibility = Visibility.Collapsed
                FrmHomepageSetup.HintCustom.Visibility = Visibility.Collapsed
                FrmHomepageSetup.HintCustomWarn.Visibility = Visibility.Collapsed
        End Select
        FrmHomepageSetup.CardCustom.TriggerForceResize()
    End Sub
    '颜色模式
