...
Public Class PageSetupLaunch
    ...
    Public Sub Reload()
        Try
            ...
            CheckAdvanceUseLwjglUnsafeAgent.Checked = Setup.Get("LaunchAdvanceUseLwjglUnsafeAgent")
    ...
    End Sub
    Private Shared Sub CheckBoxChange(sender As MyCheckBox, e As Object) Handles CheckAdvanceRunWait.Change, CheckArgumentRam.Change, CheckAdvanceDisableJLW.Change, CheckAdvanceGraphicCard.Change, CheckAdvanceDisableRW.Change, CheckAdvanceNoJavaw.Change, CheckAdvanceUseLwjglUnsafeAgent.Change
