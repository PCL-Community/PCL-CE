Class PageSetupSystem
    ...
    End Sub
    Private Shared Sub ComboChange(sender As MyComboBox, e As Object) Handles ComboAccountLoginType.SelectionChanged, ComboDownloadVersion.SelectionChanged, ComboModLocalNameStyle.SelectionChanged, ComboDownloadTranslateV2.SelectionChanged, ComboSystemUpdate.SelectionChanged, ComboSystemActivity.SelectionChanged, ComboDownloadSource.SelectionChanged, ComboSystemUpdateBranch.SelectionChanged, ComboSystemServer.SelectionChanged, ComboDownloadMod.SelectionChanged
