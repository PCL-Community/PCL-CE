    ...
    Public Shared Sub HiddenRefresh() Handles Me.Loaded
        ...
        Try
            ...
            Else
                ...
                FrmMain.BtnTitleSelect2.Visibility = If(Not (VersionBranchName = "Debug" OrElse Setup.Get("LinkAvailable")) OrElse (Not HiddenForceShow AndAlso Setup.Get("UiHiddenPageLink")), Visibility.Collapsed, Visibility.Visible) 'If(Not HiddenForceShow AndAlso Setup.Get("UiHiddenPageLink"), Visibility.Collapsed, Visibility.Visible)
