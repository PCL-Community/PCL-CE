...
#End If
    ...
    End Sub
    Private Shared Sub ComboChange(sender As MyComboBox, e As Object) Handles ComboDarkMode.SelectionChanged, ComboBackgroundSuit.SelectionChanged
...
#End Region
    ...
    Private Sub BtnHomepageSetup_Click(sender As Object, e As EventArgs) Handles BtnGotoHomepageSetup.Click
        FrmMain.PageChange(New FormMain.PageStackData With {.Page = FormMain.PageType.HomepageSetup}）
    End Sub
End Class
