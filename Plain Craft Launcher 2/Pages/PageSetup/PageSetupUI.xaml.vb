...
#End If
    ...
    Public Sub Reload()
        Try
            ...
            CheckHiddenSetupCustom.Checked = uiHidden.SetupCustom                                                                     
    ...
    CheckHiddenSetupLaunch.Change, CheckHiddenSetupUI.Change, CheckHiddenSetupSystem.Change, CheckHiddenSetupCustom.Change, CheckHiddenSetupUpdate.Change, CheckHiddenSetupGameLink.Change,
...
#Region "功能隐藏"
    ...
    Public Shared Sub HiddenRefresh() Handles Me.Loaded
        ...
        Try
            ...
            If FrmSetupLeft IsNot Nothing Then
                ...
                FrmSetupLeft.ItemCustom.Visibility = If(Not HiddenForceShow AndAlso conf.SetupCustom, Visibility.Collapsed, Visibility.Visible)
    ...
    Private Sub HiddenSetupMain() Handles CheckHiddenPageSetup.Change
        ...
        CheckHiddenSetupCustom.Checked = IsChecked
    ...
    CheckHiddenSetupAbout.Change, CheckHiddenSetupFeedback.Change, CheckHiddenSetupLog.Change
        ...
        Dim AllChecked As Boolean = conf.SetupLaunch AndAlso conf.SetupUi AndAlso conf.SetupSystem AndAlso
                               ...
                               conf.SetupFeedback AndAlso conf.SetupLog AndAlso conf.SetupCustom
