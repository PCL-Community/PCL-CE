...
public sealed partial class ThemeService
{
    ...
    private static CatColorResource[] _CalculateGrays(ToneProfile tone) => [
        ...
        LabColor.FromLch(tone.LPureWhite, alpha:tone.AHalfWhite).ToCatColor("PureHalfWhite", false),
        LabColor.FromLch(tone.LPureWhite, alpha:tone.ASemiWhite).ToCatColor("PureSemiWhite", false),
        LabColor.FromLch(tone.LPureWhite).ToCatColor("PureWhite", false),
        LabColor.FromLch(tone.LPureWhite, alpha:tone.ATransparent).ToCatColor("PureTransparent", false),
